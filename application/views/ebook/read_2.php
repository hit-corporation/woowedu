...
<body class="bg-body-tertiary">
    <nav class="navbar fixed-top shadow-sm px-2 bg-white">
        <a class="btn btn-sm btn-primary text-white" id="last-page">Kembali</a>

        <span id="page-jumper" class="input-group input-group-sm mx-auto">
            <input type="number" class="form-control form-control-sm" id="current-page-text">
            <button type="button" class="btn btn-sm btn-primary text-white" id="btn-jump">Lompati</button>
        </span>
        <div style="margin-left: auto">
            <button  class="btn btn-sm btn-primary text-white" id="previous">&lt;</button>
            <span id="current-page"></span>
            <button  class="btn btn-sm btn-primary text-white" id="next">&gt;</button>
        </div>
    </nav>
    <div class="container-fluid d-flex justify-content-center mt-5 pt-3 pb-5">
        <div id="main-content" class="mx-auto shadow-sm"></div>
    </div>
