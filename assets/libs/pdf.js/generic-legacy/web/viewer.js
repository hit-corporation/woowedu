...
const PDFViewerApplication = {
  ...
  async _initializeViewerComponents() {
    ...
    this.eventBus = eventBus;
    this.overlayManager = new _overlay_manager_js__WEBPACK_IMPORTED_MODULE_17__.OverlayManager();
    const pdfRenderingQueue = new _pdf_rendering_queue_js__WEBPACK_IMPORTED_MODULE_29__.PDFRenderingQueue();
    ...
    const findController = new _pdf_find_controller_js__WEBPACK_IMPORTED_MODULE_23__.PDFFindController({
      linkService: pdfLinkService,
      eventBus,
      updateMatchesCountOnProgress: true
    });
    this.findController = findController;
    const pdfScriptingManager = new _pdf_scripting_manager_js__WEBPACK_IMPORTED_MODULE_30__.PDFScriptingManager({
      eventBus,
      externalServices,
    ...
    const pdfViewer = new _pdf_viewer_js__WEBPACK_IMPORTED_MODULE_33__.PDFViewer({
      container,
      viewer,
      eventBus,
    ...
    if (appConfig.sidebar?.thumbnailView) {
      this.pdfThumbnailViewer = new web_pdf_thumbnail_viewer__WEBPACK_IMPORTED_MODULE_32__.PDFThumbnailViewer({
    ...
    if (!this.isViewerEmbedded && !_app_options_js__WEBPACK_IMPORTED_MODULE_9__.AppOptions.get("disableHistory")) {
      this.pdfHistory = new _pdf_history_js__WEBPACK_IMPORTED_MODULE_24__.PDFHistory({
        linkService: pdfLinkService,
        eventBus
      });
    ...
    if (!this.supportsIntegratedFind && appConfig.findBar) {
      this.findBar = new web_pdf_find_bar__WEBPACK_IMPORTED_MODULE_22__.PDFFindBar(appConfig.findBar, eventBus);
    }
    ...
    if (appConfig.documentProperties) {
      this.pdfDocumentProperties = new web_pdf_document_properties__WEBPACK_IMPORTED_MODULE_21__.PDFDocumentProperties(appConfig.documentProperties, this.overlayManager, eventBus, l10n, () => this._docFilename);
    }
    if (appConfig.secondaryToolbar?.cursorHandToolButton) {
      this.pdfCursorTools = new web_pdf_cursor_tools__WEBPACK_IMPORTED_MODULE_20__.PDFCursorTools({
        container,
        eventBus,
    ...
    if (appConfig.toolbar) {
      this.toolbar = new web_toolbar__WEBPACK_IMPORTED_MODULE_35__.Toolbar(appConfig.toolbar, eventBus);
    }
    if (appConfig.secondaryToolbar) {
      this.secondaryToolbar = new web_secondary_toolbar__WEBPACK_IMPORTED_MODULE_34__.SecondaryToolbar(appConfig.secondaryToolbar, eventBus);
    }
    if (this.supportsFullscreen && appConfig.secondaryToolbar?.presentationModeButton) {
      this.pdfPresentationMode = new web_pdf_presentation_mode__WEBPACK_IMPORTED_MODULE_27__.PDFPresentationMode({
        container,
        pdfViewer,
        eventBus
      });
    ...
    if (appConfig.passwordOverlay) {
      this.passwordPrompt = new _password_prompt_js__WEBPACK_IMPORTED_MODULE_18__.PasswordPrompt(appConfig.passwordOverlay, this.overlayManager, this.isViewerEmbedded);
    }
    if (appConfig.sidebar?.outlineView) {
      this.pdfOutlineViewer = new web_pdf_outline_viewer__WEBPACK_IMPORTED_MODULE_26__.PDFOutlineViewer({
    ...
    if (appConfig.sidebar?.attachmentsView) {
      this.pdfAttachmentViewer = new web_pdf_attachment_viewer__WEBPACK_IMPORTED_MODULE_19__.PDFAttachmentViewer({
    ...
    if (appConfig.sidebar?.layersView) {
      this.pdfLayerViewer = new web_pdf_layer_viewer__WEBPACK_IMPORTED_MODULE_25__.PDFLayerViewer({
    ...
    if (appConfig.sidebar) {
      this.pdfSidebar = new web_pdf_sidebar__WEBPACK_IMPORTED_MODULE_31__.PDFSidebar({
  ...
  get supportsCaretBrowsingMode() {
    return (0,pdfjs_lib__WEBPACK_IMPORTED_MODULE_8__.shadow)(this, "supportsCaretBrowsingMode", _app_options_js__WEBPACK_IMPORTED_MODULE_9__.AppOptions.get("supportsCaretBrowsingMode"));
  },
  ...
  load(pdfDocument) {
    ...
    const storedPromise = (this.store = new _view_history_js__WEBPACK_IMPORTED_MODULE_36__.ViewHistory(pdfDocument.fingerprints[0])).getMultiple({
      page: null,
  ...
  beforePrint() {
    ...
    this.printService = web_print_service__WEBPACK_IMPORTED_MODULE_28__.PDFPrintServiceFactory.createPrintService({
...
{
  web_print_service__WEBPACK_IMPORTED_MODULE_28__.PDFPrintServiceFactory.initGlobals(PDFViewerApplication);
}
{
...
class Preferences extends _preferences_js__WEBPACK_IMPORTED_MODULE_4__.BasePreferences {
...
class ExternalServices extends _external_services_js__WEBPACK_IMPORTED_MODULE_3__.BaseExternalServices {
  async createL10n() {
...
function createBundle(lang, text) {
  const resource = new fluent_bundle__WEBPACK_IMPORTED_MODULE_5__.FluentResource(text);
  const bundle = new fluent_bundle__WEBPACK_IMPORTED_MODULE_5__.FluentBundle(lang);
...
class GenericL10n extends _l10n_js__WEBPACK_IMPORTED_MODULE_8__.L10n {
  constructor(lang) {
    super({
      lang
    });
    ...
    this._setL10n(new fluent_dom__WEBPACK_IMPORTED_MODULE_6__.DOMLocalization([], generateBundles));
  }
  ...
  static async #createBundle(lang, baseURL, paths) {
    ...
    const text = await (0,pdfjs_lib__WEBPACK_IMPORTED_MODULE_7__.fetchData)(url, "text");
  ...
  static async #getPaths() {
    try {
      ...
      const paths = await (0,pdfjs_lib__WEBPACK_IMPORTED_MODULE_7__.fetchData)(href, "json");
      return {
...
/* harmony import */ var core_js_modules_esnext_set_difference_v2_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3375);
/* harmony import */ var core_js_modules_esnext_set_intersection_v2_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9225);
/* harmony import */ var core_js_modules_esnext_set_is_disjoint_from_v2_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3972);
/* harmony import */ var core_js_modules_esnext_set_is_subset_of_v2_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9209);
/* harmony import */ var core_js_modules_esnext_set_is_superset_of_v2_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5714);
/* harmony import */ var core_js_modules_esnext_set_symmetric_difference_v2_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(7561);
/* harmony import */ var core_js_modules_esnext_set_union_v2_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6197);
/* harmony import */ var _ui_utils_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(7256);
/* harmony import */ var _pdf_find_utils_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(3338);
/* harmony import */ var pdfjs_lib__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(4984);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([pdfjs_lib__WEBPACK_IMPORTED_MODULE_2__, _annotation_editor_layer_builder_js__WEBPACK_IMPORTED_MODULE_4__, _annotation_layer_builder_js__WEBPACK_IMPORTED_MODULE_5__, _draw_layer_builder_js__WEBPACK_IMPORTED_MODULE_7__, web_null_l10n__WEBPACK_IMPORTED_MODULE_8__, _text_layer_builder_js__WEBPACK_IMPORTED_MODULE_13__, _xfa_layer_builder_js__WEBPACK_IMPORTED_MODULE_14__]);
([pdfjs_lib__WEBPACK_IMPORTED_MODULE_2__, _annotation_editor_layer_builder_js__WEBPACK_IMPORTED_MODULE_4__, _annotation_layer_builder_js__WEBPACK_IMPORTED_MODULE_5__, _draw_layer_builder_js__WEBPACK_IMPORTED_MODULE_7__, web_null_l10n__WEBPACK_IMPORTED_MODULE_8__, _text_layer_builder_js__WEBPACK_IMPORTED_MODULE_13__, _xfa_layer_builder_js__WEBPACK_IMPORTED_MODULE_14__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
class PDFPageView {
  ...
  constructor(options) {
    ...
    this.maxCanvasPixels = options.maxCanvasPixels ?? (_app_options_js__WEBPACK_IMPORTED_MODULE_6__.AppOptions.getCompat("maxCanvasPixels") || 16777216);
    this.pageColors = options.pageColors || null;
    this.eventBus = options.eventBus;
    this.renderingQueue = options.renderingQueue;
    this.l10n = options.l10n;
    this.l10n ||= new web_null_l10n__WEBPACK_IMPORTED_MODULE_8__.GenericL10n();
...
/* harmony import */ var pdfjs_lib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4984);
/* harmony import */ var _print_utils_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(659);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([pdfjs_lib__WEBPACK_IMPORTED_MODULE_6__, _print_utils_js__WEBPACK_IMPORTED_MODULE_7__]);
([pdfjs_lib__WEBPACK_IMPORTED_MODULE_6__, _print_utils_js__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function renderPage(activeServiceOnEntry, pdfDocument, pageNumber, size, printResolution, optionalContentConfigPromise, printAnnotationStoragePromise) {
  ...
  return Promise.all([pdfDocument.getPage(pageNumber), printAnnotationStoragePromise]).then(function (_ref) {
    ...
    return renderTask.promise.catch(reason => {
      if (!(reason instanceof pdfjs_lib__WEBPACK_IMPORTED_MODULE_6__.RenderingCancelledException)) {
...
class PDFPrintService {
  ...
  renderPages() {
    if (this.pdfDocument.isPureXfa) {
      (0,_print_utils_js__WEBPACK_IMPORTED_MODULE_7__.getXfaHtmlForPrinting)(this.printContainer, this.pdfDocument);
...
class PDFPrintServiceFactory {
  ...
  static get supportsPrinting() {
    return (0,pdfjs_lib__WEBPACK_IMPORTED_MODULE_6__.shadow)(this, "supportsPrinting", true);
  }
...
/* harmony import */ var pdfjs_lib__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(4984);
