<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<form class="form-horizontal searchLastInOut" action="#" method="post" id="form_report_all">
					<div class="row">
						<div class="col-md-4">
				...
				<div class="table-responsive mt-4">
					<table id="tbl_inout" class="table table-striped table-sm nowrap">
...
<?php $this->load->view("reports/firstin-and-lastout/modal.php") ?>
...
$(document).ready(function() {
	...
	var table = $("#tbl_inout").DataTable({
		...
		ajax: {
			url: base_url + '/reports/view_last_in_out',
			dataType: "json",
			type: "POST",
			data: function(data) {
	...
	$('#tbl_inout tbody').on('click', 'button.view_data', table, function () {
