    ...
    <div class="card">
      ...
      <div class="card-content">
        <form class="row" id="edit-user-form" method="post" action="">
          ...
          <div class="input-field col s12 m6">
              <input id="rate" name="rate" type="text" value="<?php echo $user->rate; ?>">
              <label for="rate" class="">Rate</label>
          </div>
          <div class="input-field col s12 m6">
              <input id="telp" name="telp" type="text" value="<?php echo $user->telp; ?>">
              <label for="telp" class="">No. WA</label>
          </div>
          <div class="input-field col s12 m6">
              <input id="depositold" disabled name="depositold" type="text" value="<?php echo $user->deposit; ?>">
			  <input id="deposit" name="deposit" type="hidden" value="<?php echo $user->deposit; ?>">
              <label for="deposit" class="">Deposit</label>
          </div>
          <div class="input-field col s12 m6">
              <input id="topup" name="topup" type="text" value="0">
              <label for="topup" class="">Top Up Deposit</label>
          </div>
          <div class="input-field col s12 right-align">
              <button type="submit" name="submit" value="<?php echo $user->id; ?>" class="btn woowtix-bg red waves-effect waves-green">Simpan</button>
          </div>
        </form>
      </div>
    </div>
