...
<!-- Modal Import Soal-->
<section class="modal fade" tabindex="-1" id="modal-import-soal">
  <div class="modal-dialog">
    <div class="modal-content border-0">
      <div class="modal-header bg-info">
        <h5 class="modal-title text-capitalize text-light text-shadow">import Data</h5>
 ...
 <input type="hidden" id="soal_mapel"  /> 
 <input type="hidden" id="soal_materi"  /> 
            ...
            <div class=" form-group row align-items-center">
                ...
                <span class="col-8">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input form-control-sm" name="file-upload-soal" 
                            accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                        <label class="custom-file-label xl_label">Pilih File</label>
                    </div>
                </span>
            </div>
            ...
            <div class=" form-group row align-items-center">
                ...
                <span class="col-8">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input form-control-sm" name="zip-upload-soal" 
                            accept=".zip">
        ...
        <!-- PRogress bar-->
        <div class="progress mt-2" id="import-progress-soal">
          <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
        <!-- end PRogress bar-->
      </div>
